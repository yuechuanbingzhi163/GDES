...
namespace odb
{
  ...
  access::object_traits_impl< ::person, id_sqlite >::version_type
  access::object_traits_impl< ::person, id_sqlite >::
  ...
  "SELECT "
  "\"optimistic_person\".\"id\", "
  "\"optimistic_person\".\"version\", "
  "\"optimistic_person\".\"first\", "
  "\"optimistic_person\".\"last\", "
  "\"optimistic_person\".\"age\" "
  "FROM \"optimistic_person\" "
  "WHERE \"optimistic_person\".\"id\"=?";

  const char access::object_traits_impl< ::person, id_sqlite >::update_statement[] =
  "UPDATE \"optimistic_person\" "
  "SET "
  "\"version\"=\"version\"+1, "
  "\"first\"=?, "
  "\"last\"=?, "
  ...
  "DELETE FROM \"optimistic_person\" "
  "WHERE \"id\"=?";

  const char access::object_traits_impl< ::person, id_sqlite >::optimistic_erase_statement[] =
  "DELETE FROM \"optimistic_person\" "
  "WHERE \"id\"=? AND \"version\"=?";
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"optimistic_person\"");
          return false;
        }
      }
    }
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"optimistic_person\" (\n"
