...
AC_IMPLEMENT_EXTENSION_MODULE( DrawVentCmdDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE DrawVentCmdExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        DrawVentCmdDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        DrawVentCmdDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
