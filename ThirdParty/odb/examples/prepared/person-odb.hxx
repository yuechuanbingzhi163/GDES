...
namespace odb
{
  ...
  //
  template <>
  class access::view_traits_impl< ::person_count, id_sqlite >:
  ...
  class access::view_traits_impl< ::person_count, id_common >:
    public access::view_traits_impl< ::person_count, id_sqlite >
  {
  };
  ...
  // person_count
  //
  struct access::view_traits_impl< ::person_count, id_sqlite >::query_columns:
