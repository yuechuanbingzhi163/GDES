...
class SimpelDirectionDraw : public MineGEDraw
{
public:
	ACRX_DECLARE_MEMBERS(SimpelDirectionDraw);

public:
	SimpelDirectionDraw();
	~SimpelDirectionDraw(void);
...
ACDB_REGISTER_OBJECT_ENTRY_AUTO(SimpelDirectionDraw)
#endif