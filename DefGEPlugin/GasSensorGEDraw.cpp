...
ACRX_CONS_DEFINE_MEMBERS ( GasSensorGEDraw, MineGEDraw, 1 )

GasSensorGEDraw::GasSensorGEDraw()
{

}

GasSensorGEDraw::~GasSensorGEDraw( void )
{
}

void GasSensorGEDraw::setAllExtraParamsToDefault()
{
	m_radius = 3;
	m_temp = _T("");
}

void GasSensorGEDraw::configExtraParams()
{

}

void GasSensorGEDraw::updateExtraParams()
{

}

void GasSensorGEDraw::writeKeyParam( DrawParamWriter& writer )
{
	writer.writePoint( m_insertPt );
	writer.writeDouble( m_angle );
}

void GasSensorGEDraw::readKeyParam( DrawParamReader& reader )
{
	reader.readPoint( m_insertPt );
	reader.readDouble( m_angle );
}

void GasSensorGEDraw::readExtraParam( DrawParamReader& reader )
{
	reader.readDouble( m_radius );
	reader.readString( m_temp );
}

void GasSensorGEDraw::writeExtraParam( DrawParamWriter& writer )
{
	writer.writeDouble( m_radius );
	writer.writeString( m_temp );
}

Adesk::Boolean GasSensorGEDraw::subWorldDraw( AcGiWorldDraw* mode )
{
	assertReadEnabled () ;
...
Acad::ErrorStatus GasSensorGEDraw::subTransformBy( const AcGeMatrix3d& xform )
{
	// 插入点变换
...
Acad::ErrorStatus GasSensorGEDraw::subGetOsnapPoints (
...
Acad::ErrorStatus GasSensorGEDraw::subGetGripPoints( AcGePoint3dArray& gripPoints, AcDbIntArray& osnapModes, AcDbIntArray& geomIds ) const
{
	assertReadEnabled () ;
...
Acad::ErrorStatus GasSensorGEDraw::subMoveGripPointsAt( const AcDbIntArray& indices, const AcGeVector3d& offset )
{
	assertWriteEnabled () ;
...
void GasSensorGEDraw::regPropertyDataNames( AcStringArray& names ) const
{
	names.append(_T("瓦斯浓度"));
}

void GasSensorGEDraw::readPropertyDataFromGE( const AcStringArray& values )
{
	CString strLenth;
