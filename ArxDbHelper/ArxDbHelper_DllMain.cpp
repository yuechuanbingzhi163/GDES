...
AC_IMPLEMENT_EXTENSION_MODULE(ArxDbHelperDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE ArxDbHelperExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		ArxDbHelperDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		ArxDbHelperDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
