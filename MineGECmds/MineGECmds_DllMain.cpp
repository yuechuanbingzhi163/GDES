...
AC_IMPLEMENT_EXTENSION_MODULE( MineGECmdsDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE MineGECmdsExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        MineGECmdsDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        MineGECmdsDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
