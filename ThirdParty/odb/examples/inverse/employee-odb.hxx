...
namespace odb
{
  ...
  class access::object_traits< ::position >
  {
    ...
    typedef ::std::tr1::shared_ptr< ::position > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;
...
namespace odb
{
    ...
    public access::object_traits< ::employer >
  {
    ...
    struct employees_traits
    {
      ...
      typedef sqlite::container_statements< employees_traits > statements_type;
  ...
  template <typename A>
  const typename pointer_query_columns< ::position, id_sqlite, A >::id_type_
  pointer_query_columns< ::position, id_sqlite, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::position, id_sqlite, A >::title_type_
  pointer_query_columns< ::position, id_sqlite, A >::
  ...
  //
  template <typename A>
  struct query_columns< ::project, id_sqlite, A >
  {
    // name
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::project, id_sqlite, A >::name_type_
  query_columns< ::project, id_sqlite, A >::
  name (A::table_name, "\"name\"", 0);

  template <typename A>
  struct pointer_query_columns< ::project, id_sqlite, A >:
    query_columns< ::project, id_sqlite, A >
  {
  };

  template <>
  class access::object_traits_impl< ::project, id_sqlite >:
  ...
  class access::object_traits_impl< ::project, id_common >:
    public access::object_traits_impl< ::project, id_sqlite >
  {
  };
  ...
  template <typename A>
  const typename pointer_query_columns< ::employee, id_sqlite, A >::position_type_
  pointer_query_columns< ::employee, id_sqlite, A >::
    ...
    public access::object_traits< ::employee >
  {
    ...
    struct projects_traits
    {
      ...
      typedef ordered_functions<index_type, value_type> functions_type;
      typedef sqlite::container_statements< projects_traits > statements_type;
  ...
  template <typename A>
  const typename query_columns< ::position, id_sqlite, A >::id_type_
  query_columns< ::position, id_sqlite, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::position, id_sqlite, A >::title_type_
  query_columns< ::position, id_sqlite, A >::
  title (A::table_name, "\"title\"", 0);
  ...
  template <typename A>
  const typename query_columns< ::employee, id_sqlite, A >::position_type_
  query_columns< ::employee, id_sqlite, A >::
  position (A::table_name, "\"position\"", 0);
}
