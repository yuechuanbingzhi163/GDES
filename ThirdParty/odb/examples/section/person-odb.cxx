...
namespace odb
{
  ...
  {
    sqlite::smart_container_statements_impl< nicknames_traits > nicknames_;

    sqlite::section_statements< ::person, extras_traits > extras_;
  ...
  std::size_t access::object_traits_impl< ::person, id_sqlite >::extras_traits::
  bind (sqlite::bind* b,
        const sqlite::bind* id,
        std::size_t id_size,
        image_type& i,
  ...
  bool access::object_traits_impl< ::person, id_sqlite >::extras_traits::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::object_traits_impl< ::person, id_sqlite >::extras_traits::
  init (object_type& o,
        const image_type& i,
        database* db)
  {
  ...
  const char access::object_traits_impl< ::person, id_sqlite >::extras_traits::
  select_statement[] =
  "SELECT "
  "\"section_person\".\"bio\" "
  "FROM \"section_person\" "
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"section_person_nicknames\"");
          db.execute ("DROP TABLE IF EXISTS \"section_person\"");
          return false;
        }
      }
    }
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"section_person\" (\n"
                      "  \"id\" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,\n"
                      "  \"first\" TEXT NOT NULL,\n"
                      "  \"last\" TEXT NOT NULL,\n"
                      "  \"bio\" TEXT NOT NULL)");
          db.execute ("CREATE TABLE \"section_person_nicknames\" (\n"
                      ...
                      "    ON DELETE CASCADE)");
          db.execute ("CREATE INDEX \"section_person_nicknames_object_id_i\"\n"
                      "  ON \"section_person_nicknames\" (\"object_id\")");
          db.execute ("CREATE INDEX \"section_person_nicknames_index_i\"\n"
