...
namespace odb
{
  ...
  bool access::view_traits_impl< ::person_count, id_sqlite >::
  grow (image_type& i,
        bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::person_count, id_sqlite >::
  bind (sqlite::bind* b,
        image_type& i)
  {
    using namespace sqlite;
  ...
  access::view_traits_impl< ::person_count, id_sqlite >::query_base_type
  access::view_traits_impl< ::person_count, id_sqlite >::
  ...
  result< access::view_traits_impl< ::person_count, id_sqlite >::view_type >
  access::view_traits_impl< ::person_count, id_sqlite >::
  query (database&, const query_base_type& q)
  {
    using namespace sqlite;
