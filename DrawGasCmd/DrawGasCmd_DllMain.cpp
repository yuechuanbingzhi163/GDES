...
AC_IMPLEMENT_EXTENSION_MODULE( DrawGasCmdDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE DrawGasCmdExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        DrawGasCmdDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        DrawGasCmdDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
