...
class TempeSensorGEDraw : public MineGEDraw
{
public:
	ACRX_DECLARE_MEMBERS(TempeSensorGEDraw);

public:
	TempeSensorGEDraw();
	~TempeSensorGEDraw(void);
...
ACDB_REGISTER_OBJECT_ENTRY_AUTO(TempeSensorGEDraw)
#endif