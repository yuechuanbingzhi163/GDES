...
class DetermineHoleGEDraw : public MineGEDraw
{
public:
	ACRX_DECLARE_MEMBERS(DetermineHoleGEDraw);

public:
	DetermineHoleGEDraw();
	~DetermineHoleGEDraw(void);
...
ACDB_REGISTER_OBJECT_ENTRY_AUTO(DetermineHoleGEDraw)
#endif