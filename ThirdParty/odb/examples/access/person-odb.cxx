...
namespace odb
{
        ...
        sqlite::statement_kind sk)
  {
    ...
    b[n].type = sqlite::image_traits<
      ::std::string,
      sqlite::id_text>::bind_value;
    b[n].buffer = i.middle_value.data ();
  ...
  "\"access_person\".\"email\", "
  "\"access_person\".\"first\", "
  "\"access_person\".\"middle\", "
  "\"access_person\".\"last\", "
  "\"access_person\".\"age\" "
  "FROM \"access_person\" "
  "WHERE \"access_person\".\"email\"=?";
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"access_person\"");
          return false;
        }
      }
    }
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"access_person\" (\n"
