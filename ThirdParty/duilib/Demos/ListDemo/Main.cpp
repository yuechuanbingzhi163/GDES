    ...
    */
    ...
    void Notify(TNotifyUI& msg)
    {
        ...
        else if(msg.sType == _T("menu")) 
        {
            ...
            //pMenu->Init(msg.pSender, _T("menu.xml"), pt, &m_pm);
			pMenu->Init(NULL, _T("menu.xml"), pt, &m_pm);
        }
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
    ...
    pFrame->Create(NULL, _T("skin.xml"), UI_WNDSTYLE_FRAME, WS_EX_STATICEDGE | WS_EX_APPWINDOW , 0, 0, 600, 320);
    pFrame->CenterWindow();
