...
AC_IMPLEMENT_EXTENSION_MODULE( GasGEPluginDLL )
...
#ifdef NEVER
AFX_EXTENSION_MODULE GasGEPluginExtDLL = { NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain ( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
    ...
    if ( dwReason == DLL_PROCESS_ATTACH )
    {
        ...
        GasGEPluginDLL.AttachInstance ( hInstance ) ;
        InitAcUiDLL () ;
    }
    else if ( dwReason == DLL_PROCESS_DETACH )
    {
        GasGEPluginDLL.DetachInstance () ;
    }
    return ( TRUE ) ;
}
