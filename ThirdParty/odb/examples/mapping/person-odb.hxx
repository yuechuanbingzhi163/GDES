...
namespace odb
{
  ...
  struct query_columns< ::person, id_sqlite, A >
  {
    ...
    static const married_type_ married;
  };
  ...
  template <typename A>
  const typename query_columns< ::person, id_sqlite, A >::born_type_
  query_columns< ::person, id_sqlite, A >::
  born (A::table_name, "\"born\"", 0);

  template <typename A>
  const typename query_columns< ::person, id_sqlite, A >::married_type_
  query_columns< ::person, id_sqlite, A >::
  married (A::table_name, "\"married\"", 0);
    ...
    public access::object_traits< ::person >
  {
    ...
    struct image_type
    {
      ...
      // born_
      //
      details::buffer born_value;
      std::size_t born_size;
      bool born_null;

      // married_
      //
      details::buffer married_value;
      std::size_t married_size;
      bool married_null;
