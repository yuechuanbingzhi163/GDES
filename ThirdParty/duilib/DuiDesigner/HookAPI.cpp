...
CHookAPI::CHookAPI(void)
{
	...
	HookAPI(_T("Uilib_ud.dll"),LPCSTR("?Invalidate@CPaintManagerUI@UiLib@@QAEXAAUtagRECT@@@Z"),(FARPROC)Hook_Invalidate,m_InvalidateHookInfo);
	EnableInvalidate(true);

	HookAPI(_T("Uilib_ud.dll"),LPCSTR("?GetImageEx@CPaintManagerUI@UiLib@@QAEPAUtagTImageInfo@2@PB_W0K@Z"),(FARPROC)Hook_GetImageEx,m_GetImageExHookInfo);
	...
	HookAPI(_T("Uilib_u.dll"),LPCSTR("?Invalidate@CPaintManagerUI@UiLib@@QAEXAAUtagRECT@@@Z"),(FARPROC)Hook_Invalidate,m_InvalidateHookInfo);
	EnableInvalidate(true);

	HookAPI(_T("Uilib_u.dll"),LPCSTR("?GetImageEx@CPaintManagerUI@UiLib@@QAEPAUtagTImageInfo@2@PB_W0K@Z"),(FARPROC)Hook_GetImageEx,m_GetImageExHookInfo);
	EnableGetImageEx(true);
#endif
}
