...
namespace odb
{
  ...
  "INSERT INTO \"schema_embedded_person\" "
  "(\"id\", "
  "\"first\", "
  "\"last\", "
  "\"age\") "
  ...
  "SELECT "
  "\"schema_embedded_person\".\"id\", "
  "\"schema_embedded_person\".\"first\", "
  "\"schema_embedded_person\".\"last\", "
  "\"schema_embedded_person\".\"age\" "
  "FROM \"schema_embedded_person\" "
  "WHERE \"schema_embedded_person\".\"id\"=?";

  const char access::object_traits_impl< ::person, id_sqlite >::update_statement[] =
  "UPDATE \"schema_embedded_person\" "
  "SET "
  "\"first\"=?, "
  "\"last\"=?, "
  "\"age\"=? "
  ...
  "DELETE FROM \"schema_embedded_person\" "
  "WHERE \"id\"=?";
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"schema_embedded_person\"");
          return false;
        }
      }
    }
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"schema_embedded_person\" (\n"
