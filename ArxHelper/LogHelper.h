...
class ARXHELPER_DLLIMPEXP cruise_log4cplus
{
public:
...
extern ARXHELPER_DLLIMPEXP void log_init(tchar* prop_file, tchar* prefix_log_flie = NULL, tchar* sub_logger_name = NULL);
extern ARXHELPER_DLLIMPEXP void log_uinit();